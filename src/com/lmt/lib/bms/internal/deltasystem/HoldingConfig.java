...
class HoldingConfig extends RatingConfig {
	...
	LinearInterpolateFunction ipfnLnTime = LinearInterpolateFunction.create(
			1.0, 1.2, 0.5, 0.56, 0.605, 0.65, 0.69, 0.72, 0.76, 0.78, 0.8, 0.813, 0.825, 0.83, 0.835, 0.839, 0.843, 0.847, 0.85, 0.854, 0.858, 0.864, 0.867, 0.873, 0.878, 0.884, 0.89, 0.895, 0.901, 0.906, 0.912, 0.917);
